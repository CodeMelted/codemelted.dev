    ...
    const HEADER_TEMPLATE = `
        <hr style="margin: 0; padding: 0;" />    
            <div style='margin: 0; padding: 0; background-color: darkslategray'>
                <div style='text-align: center; background-color: darkslategray; display: grid; grid-template-columns: auto auto auto;'>
                    <a style='font-size: small; font-weight: bold; text-decoration: none; color: white;' href="https://blog.codemelted.dev" rel="noopener"><img width="48px" height="48px" src="https://codemelted.dev/website-nav/images/icons8-blog-48.png" alt="blog.codemelted.dev" /><br />Blog</a>
                    <a style='font-size: small; font-weight: bold; text-decoration: none; color: white;' href="https://jeeplife.codemelted.dev" rel="noopener"><img width="48px" height="48px" src="https://codemelted.dev/website-nav/images/jeep-life-logo.png" alt="jeeplife.codemelted.dev" /><br />Jeep Life</a>
                    <a style='font-size: small; font-weight: bold; text-decoration: none; color: white;' href="https://techinfo.codemelted.dev" rel="noopener"><img width="48px" height="48px" src="https://codemelted.dev/website-nav/images/icons8-computer-support-48.png" alt="techinfo.codemelted.dev" /><br />Tech Info</a>
                </div>
